...
@NgModule({
  ...
  exports: [ ...modules ],
  providers: [
    { provide: MatPaginatorIntl, useClass: MatPaginatorIntlPersianService},
    { provide: DateAdapter, useClass: JalaliMomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    { provide: MAT_DATE_LOCALE, useValue: "fa-IR"},
    { provide: MAT_DATE_FORMATS, useFactory: locale => {
      if (locale === "fa-IR") return JALALI_MOMENT_FORMATS;
